...
const BookingDetails = () => {
  ...
  return (
    <div>
      ...
      {/* img data bio */}
      <div className=" mx-auto mt-10 space-y-4 p-6 bg-white shadow-lg rounded-lg flex">
        <div className="w-1/3">
          <img
            src={image}
            alt={name}
      ...
      <div className="bg-white my-10">
        ...
        <h1 className="text-yellow-600 bg-amber-100 p-2 rounded-full w-4/5 text-lg mx-auto"><i class="ri-error-warning-line"></i><span>Due to high patient volume, we are currently accepting appointments for today only. We appreciate your understanding and cooperation.</span></h1>

        <Link to="/bookings">
          <button
            onClick={() => addItem(single)}
            className="w-full text-white bg-blue-700 border p-2 py-3 text-xl font-semibold rounded-full hover:bg-indigo-800 cursor-pointer "
          >
